...
public class PerfilMedico {
	...
	public PerfilMedico(String name, String lastName, char sex, int day, int month, int year, double height,
			double weight) {
	...
	public void frecCardProm() {
		...
		System.out.printf("Rango de Frecuencia Cardiaca Promedio: %.0f y %.0f", (220 - periodo.getYears()) * 0.5,
