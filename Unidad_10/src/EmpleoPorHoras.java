...
public class EmpleoPorHoras extends Empleado{

	private double horas;
	private double sueldo;


	public EmpleoPorHoras(String primerNombre, String apellidoPaterno, String numeroSeguroSocial,double sueldo, double horas) 
	{
